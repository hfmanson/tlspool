...
#endif
#include "nl_mansoft_tlspoolsocket_TlspoolSocket_PlainInputStream.h"   // Generated
 ...
 * Signature: ([BII)I
 */
JNIEXPORT jint JNICALL Java_nl_mansoft_tlspoolsocket_TlspoolSocket_00024PlainInputStream_readPlain
(JNIEnv *env, jobject thisObj, jbyteArray inJNIArray, jint off, jint len)
{
	...
	int bytesread = recv(fd, (char*) inCArray + off, len, 0);
